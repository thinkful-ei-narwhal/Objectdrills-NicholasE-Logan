...
function createCharacter(nameofChar, nickNameOfChar, raceofChar, origOfChar, atkOfChar, defOfChar) {
  return {
    Name: nameofChar,
...
function findOne(arr, query) {
  ...
  Object.values(query).forEach(queryVal => reducedHeroesList = reducedHeroesList.filter(e => Object.values(e).find(k => k === queryVal)));
